...
struct himax_i2c_platform_data chacha_ts_himax_data[] = {
	{
		...
		.command_c0 = { 0xC0, 0x05, 0x03, 0x23},
		.command_62 = { 0x62, 0x14, 0x23, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x14, 0x00},
		.command_63 = { 0x63, 0x42, 0x31, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x01},
		.command_64 = { 0x64, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04},
		.command_65 = { 0x65, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00},
		.command_66 = { 0x66, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04},
		.command_67 = { 0x67, 0x03, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00},
		.command_68 = { 0x68, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
		.command_69 = { 0x69, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
		.command_6a = { 0x6A, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00},
		.command_6b = { 0x6B, 0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x30, 0x00},
		.command_6c = { 0x6C, 0x20, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
		.command_6d = { 0x6D, 0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x30, 0x00},

		.command_c9 = { 0xC9, 0x00, 0x00, 0x00, 0x00, 0x00, 0x20, 0x20, 0x20, 0x17, 0x17, 0x17, 0x23, 0x23, 0x23,
				0x12, 0x12, 0x12, 0x1A, 0x1A, 0x1A, 0x13, 0x13, 0x13, 0x19, 0x19, 0x19,
				0x0E, 0x0E, 0x0E, 0x18, 0x18, 0x18, 0x00, 0x00, 0x00, 0x00},
		.command_cb = { 0xCB, 0x01, 0xFF, 0xFF, 0xFF, 0x01, 0x03, 0xF0, 0x02, 0x00, 0x00},
		...
		.command_b3 = { 0xB3, 0x05, 0x14, 0x12, 0x0A, 0x03, 0x0D, 0x10, 0x0B, 0x00, 0x00,
				0x00, 0x09, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x06, 0x00, 0x11, 0x07,
				0x00, 0x00, 0x0F, 0x00, 0x00, 0x00, 0x00, 0x0C, 0x00, 0x00, 0x00, 0x01, 0x00,
				0x00, 0x00, 0x08, 0x00, 0x00, 0x13, 0x0E, 0x00, 0x00, 0x00, 0x02, 0x00},
		.command_c5 = { 0xC5, 0x0A, 0x18, 0x08, 0x10, 0x18, 0x1F, 0x0B},
		.command_c6 = { 0xC6, 0x13, 0x10, 0x1A},
		.command_7a = { 0x7A, 0x00, 0xD8, 0x0C},
		.command_78 = { 0x78, 0x00},
		.command_3a = { 0x3A, 0x00},
		.command_e9 = { 0xE9, 0x00, 0x74},
		.command_ea = { 0xEA, 0x09, 0x0B, 0x03, 0x04},

		.command_eb = { 0xEB, 0x14, 0x00, 0x0A, 0x22},
		.command_ec = { 0xEC, 0x04, 0x00, 0x04, 0x00, 0x41, 0x14, 0x02, 0x00, 0x11},
		.command_ee = { 0xEE, 0x03},
		.command_ed = { 0xED, 0x01, 0x01, 0x00, 0x00},
		.command_ef = { 0xEF, 0x05, 0x78},
		.command_f0 = { 0xF0, 0x04},
		.command_f1 = { 0xF1, 0x04, 0x0A, 0x03, 0x03},
		.command_f2 = { 0xF2, 0x08, 0xC8, 0x03, 0x03},
		.command_f3 = { 0xF3, 0xC8},
		.command_f4 = { 0xF4, 0xDC, 0x50, 0xDC, 0x50},
		.command_f7 = { 0xF7, 0x05, 0x3C, 0xC8, 0x00, 0x0A},
...
static uint32_t usb_ID_PIN_input_table[] = {
	PCOM_GPIO_CFG(CHACHA_GPIO_USB_ID_PIN, 0, GPIO_INPUT, GPIO_NO_PULL, GPIO_4MA),
};
...
static struct msm_hsusb_platform_data msm_hsusb_pdata = {
	...
	.config_usb_id_gpios	= config_chacha_usb_id_gpios,
};
...
static struct cm3628_platform_data cm3628_pdata = {
	...
	.levels = { 1, 3, 68, 131, 282, 1779, 2627, 2770, 2912, 65535},
	.golden_adc = 0x8CB,
